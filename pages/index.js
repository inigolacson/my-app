...
import GraphicButton from "@component/graphicButton";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Iñigo Lacson — Frontend Developer, UI/UX Designer, and Game Developer"
        />

        <meta property="og:title" content="Iñigo Lacson | Frontend Developer" />
        <meta
          property="og:description"
          content="Explore my work, projects, and skills."
        />
        <meta
          property="og:image"
          content="https://porfolio-ashen-eight.vercel.app/og-image.jpg"
        />
        <meta
          property="og:url"
          content="https://porfolio-ashen-eight.vercel.app/"
        />
          ...
          <div className={styles.left}>
            <section className={hero.heroContainer}>
              ...
              <p className={hero.moto}>
                <span className={styles.normal}>🤷‍♂️</span> {info.motto}
              </p>
              <div className={resume.resumeContainer}>
                <ResumeButton />
                <GraphicButton />
              </div>
              <p className={hero.rights}>
                © 2025 @inigolacson — All rights reserved.
              </p>
            </section>
          </div>
